...
const Button = (props) => {
	const buildBackgroundButton = (type) => {
		switch (type) {
			...
			case SECONDARY_TYPE:
				return 'border-gray-400 bg-red-500 hover:bg-red-600 text-white'
			case WARNING_TYPE:
				return 'border-yellow-500 bg-yellow-500 hover:bg-yellow-600 text-white'
			case DANGER_TYPE:
				return 'border-red-700 bg-red-700 hover:bg-indigo-800 text-white'
			case WHITE_TYPE:
				return 'border-gray-200 bg-white hover:bg-white-800 text-gray'
			default:
